                    ...
                    <div className="md:hidden bg-white border border-primary-200 rounded-lg shadow-sm overflow-x-auto">
                        <nav className="flex -mb-px min-w-max">
                            <button
                                ...
                                className={`px-4 py-3 text-xs font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === 'pending'
                            ...
                            >
                                ...
                                {bookings.length > 0 && activeTab === 'pending' && (
                                    <span className="ml-2 bg-primary-200 text-primary-700 px-2 py-0.5 rounded-full text-xs font-semibold">
                                        {bookings.length}
                                    </span>
                                )}
                            </button>
                            <button
                                ...
                                className={`px-4 py-3 text-xs font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === 'active'
                                    ? 'border-primary-500 text-primary-600 bg-primary-50'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                    }`}
                            ...
                            <button
                                ...
                                className={`px-4 py-3 text-xs font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === 'completed'
                                    ? 'border-primary-500 text-primary-600 bg-primary-50'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                    }`}
                    ...
                    <aside className="hidden md:block md:w-64 shrink-0">
                        <div className="bg-white border border-primary-200 rounded-lg shadow-sm overflow-hidden sticky top-4">
                            <nav className="flex flex-col">
                                <button
                                    onClick={() => setActiveTab('pending')}
                                    className={`px-6 py-4 text-sm font-medium border-l-4 transition-all text-left ${activeTab === 'pending'
                                        ? 'border-primary-500 text-primary-600 bg-primary-50'
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        {bookings.length > 0 && activeTab === 'pending' && (
                                            <span className="bg-primary-200 text-primary-700 px-2 py-0.5 rounded-full text-xs font-semibold">
                                                {bookings.length}
                                            </span>
                                        )}
                                    </div>
                                ...
                                <button
                                    onClick={() => setActiveTab('active')}
                                    className={`px-6 py-4 text-sm font-medium border-l-4 transition-all text-left ${activeTab === 'active'
                                        ? 'border-primary-500 text-primary-600 bg-primary-50'
                                        : 'border-transparent text-gray-600 hover:text-gray-900 hover:bg-gray-50 hover:border-gray-300'
                                        }`}
                                    data-testid="tab-active"
                                ...
                                <button
                                    onClick={() => setActiveTab('completed')}
                                    className={`px-6 py-4 text-sm font-medium border-l-4 transition-all text-left ${activeTab === 'completed'
                                        ? 'border-primary-500 text-primary-600 bg-primary-50'
                                        : 'border-transparent text-gray-600 hover:text-gray-900 hover:bg-gray-50 hover:border-gray-300'
                                        }`}
                                    data-testid="tab-completed"
